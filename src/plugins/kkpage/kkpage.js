var kkpager = {
	...
	generPageHtml : function(config, enforceInit) {
		console.log("config.pagerid:"+config.pagerid);
		console.log("初始化:"+JSON.stringify(config)+",哈哈:"+enforceInit);
		...
		if (this.isShowFirstPageBtn) {
			if (this.hasPrv) {
				...
				str_first = '<span class="disabled">' + this.lang.firstPageText
						+ "</span>"
			}
		}
		...
		if (this.isShowNextPageBtn) {
			if (this.hasNext) {
				...
				str_next = '<span class="disabled">' + this.lang.nextPageText
						+ "</span>"
			}
		}
		if (this.isShowLastPageBtn) {
			if (this.hasNext) {
				...
				str_last = '<span class="disabled">' + this.lang.lastPageText
						+ "</span>"
			}
		}
		var str = "";
	...
	_getHandlerStr : function(n) {
		if (this.mode == "click") {
			return 'href="' + this.getHref(n)
					+ '" onclick="return kkpager._clickHandler(' + n + ')"'
		}
...
var kkpager_back = {
		...
		generPageHtml : function(config, enforceInit) {
			...
			if (this.isGoPage) {
				gopage_info = '<span class="goPageBox">'
						...
						+ '<input type="text" id="'
						+ this.gopageTextboxId
						+ '" onfocus="kkpager_back.focus_gopage()"  onkeypress="return kkpager_back.keypress_gopage(event);"   onblur="kkpager_back.blur_gopage()" value="'
						+ this.next + '" /></span>' + this.lang.gopageAfterText
						+ '<input type="button" id="' + this.gopageButtonId
						+ '" onclick="kkpager_back.gopage()" value="'
						+ this.lang.gopageButtonOkText + '" />' + "</span>"
			}
			if (this.total <= 8) {
				for ( var i = 1; i <= this.total; i++) {
		...
		_getHandlerStr : function(n) {
			if (this.mode == "click") {
				return 'href="' + this.getHref(n)
						+ '" onclick="return kkpager_back._clickHandler(' + n + ')"'
			}
			return 'href="' + this.getLink(n) + '"'
		},
		_clickHandler : function(n) {
